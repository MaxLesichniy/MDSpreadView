#
#  Be sure to run `pod spec lint MDSpreadView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Mochi Development, Inc." => "http://mochidev.com/open" }
  # Or just: s.author    = "MaxLesichniy"
  # s.authors            = { "MaxLesichniy" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/MaxLesichniy/MDSpreadView.git", :tag => "#{s.version}" }
